...
def repeat_all_messages(message): 
    ...
    if Labeladmin == 'good':
        ...
        if iz_srtok02_kl01 == message_in:
            ...
            message_out = message_out + 'Каков статус моего заказа?\nТут идёт поиск как при загрузке бота.\n'                        
            bot.send_message(user_id,message_out,parse_mode='HTML')       
                        
        if iz_srtok03_kl01 == message_in:
            Labeladmin = 'bad' 
            message_out = ''
            message_out = message_out + 'Мне нужна техническая помощь в работе с конструктором\nОпишите, пожалуйста, вашу проблему\n'
